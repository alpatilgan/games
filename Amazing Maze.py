...
def draw_row(row, squares):
    ...
    for square in squares:
        if square == "1":
            wall = canvas.create_rectangle(column * 30, row * 30, column * 30 + 30, row * 30 + 30, fill = 'green')
            walls.append(wall)
        column += 1
        
draw_row(0, "10111111111111111111")
draw_row(1, "10000000010000010001")
draw_row(2, "11010111011011010101")
draw_row(3, "10010101000010010111")
draw_row(4, "11010111011011010101")
draw_row(5, "10000101110000000001")
draw_row(6, "10110101010010111101")
draw_row(7, "10100001011110101001")
